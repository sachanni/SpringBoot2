package net.gide.springboot2.employee;
...
public class SpringRestClient {
	...
	private void createEmployee() {
		...
		Employee newEmployee = new Employee("admin", "admin", "admin@gmail.com","9898877665");
	...
	private void updateEmployee() {
		Map<String, String> params = new HashMap<String, String>();
		params.put("id", "1");
		Employee updatedEmployee = new Employee("admin123", "admin123", "admin123@gmail.com","9898877665");
		RestTemplate restTemplate = new RestTemplate();
